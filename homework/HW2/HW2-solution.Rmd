...
```
Answer: Some of you did simulations to answer this question, but an quickly ran into computational issues with the large sample sizes. This is a perfect example of when an approximate answer is worth the error in approximation. This answer also probably gives you some idea of why casinos try to keep you at the table with free drinks!
