...
Answer: Normal approxmation tell us the average profit $S/N$ has expected value $\mu=$`expectation` and standard deviation $\sigma=$

```{r}
## From 2A we have the expectation is
N <- 1000
loan <- 180000
loss_per_foreclosure <- 120000
p <- 0.02
...
$$ \sqrt{N} = z \frac{(x + l) \sqrt{p(1-p) } }{ x (1-p) - l p } $$
