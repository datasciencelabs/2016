...
Assessment: Read in the data [here]("https://raw.githubusercontent.com/datasciencelabs/data/master/bio260_heights.csv"). Use the `filter` function to determine how many males and females we have.
